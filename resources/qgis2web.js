                                    ...
                                    <li>
                                        ...
                                        <div class="tab-content" id="${uniqueId}-tab1" style="display:block;">
                                            <table>
                                                <tr>
                                                    ...
                                                    <td class="col6">${feature.properties['OR holder'] ? feature.properties['OR holder'] : '<span style="color: #b4b4b4; font-weight: normal;">N/A</span>'}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col6">${feature.properties['FR holder'] ? feature.properties['FR holder'] : '<span style="color: #b4b4b4; font-weight: normal;">N/A</span>'}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col6">${feature.properties['WOR holder'] ? feature.properties['WOR holder'] : '<span style="color: #b4b4b4; font-weight: normal;">N/A</span>'}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="col6">${feature.properties['WFR holder'] ? feature.properties['WFR holder'] : '<span style="color: #b4b4b4; font-weight: normal;">N/A</span>'}</td>
                                        ...
                                        <div class="tab-content" id="${uniqueId}-tab2" style="display:none;">
                                            <table>
                                                ...
                                                <tr>
                                                    <td class="col-tab2">${feature.properties['p_OR'] ? feature.properties['p_OR'].replace(/,\s*/g, '<br>') : '<span style="font-weight: normal;">N/A</span>'}</td>
                                                </tr>
                                                <tr>
                                                    <td class="tab2-titles">Female Records</td>
                                                </tr>
                                                <tr>
                                                    <td class="col-tab2">${feature.properties['p_FR'] ? feature.properties['p_FR'].replace(/,\s*/g, '<br>') : '<span style="font-weight: normal;">N/A</span>'}</td>
                                                </tr>
                                                <tr>
                                                    <td class="tab2-titles">Winter Open Records</td>
                                                </tr>
                                                <tr>
                                                    <td class="col-tab2">${feature.properties['p_WOR'] ? feature.properties['p_WOR'].replace(/,\s*/g, '<br>') : '<span style="font-weight: normal;">N/A</span>'}</td>
                                                </tr>
                                                <tr>
                                                    <td class="tab2-titles">Winter Female Records</td>
                                                </tr>
                                                <tr>
                                                    <td class="col-tab2">${feature.properties['p_WFR'] ? feature.properties['p_WFR'].replace(/,\s*/g, '<br>') : '<span style="font-weight: normal;">N/A</span>'}</td>
                                                </tr>
                                            </table>
                                        </div>
                                    </li>
