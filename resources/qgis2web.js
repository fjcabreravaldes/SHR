                ...
                if (doPopup) {
                    for (var n = 0; n < clusteredFeatures.length; n++) {
                        ...
                        popupText += '<c><b>' + currentFeature.get('dist_km') +'<c style="font-size: 13px;"> km &nbsp;</c>' +
                                                ...
                                                currentFeature.get('cimb_ft') +'<c style="font-size: 13px;"> ft</c>' + '</b></c>';
                        ...
                        <div class="tab-content" id="${uniqueId}-tab1" style="display:block;">
                            <table>
                                <tr>
                                    ...
                                    <td class="col6">${currentFeature.get('OR holder') ? currentFeature.get('OR holder') : '<span style="font-weight: normal;">N/A</span>'}</td>
